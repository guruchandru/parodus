...
int sendXmidtEventToServer(XmidtMsg *msgnode, wrp_msg_t * msg, rbusMethodAsyncHandle_t asyncHandle)
{
	...
	if(notif_wrp_msg != NULL)
	{
		...
		if(msg->u.event.payload != NULL)
		{
			...
			ParodusInfo("Notification payload Test1: {\"Report\":[{\"Profile.Name\":\"lte_bkp_periodic_report\"},{\"Profile.Version\":\".21\"},{\"timestamp\":\"1686513316.002683748\"},{\"Device.DeviceInfo.ProductClass\":\"XLE\"},{\"Device.DeviceInfo.X_COMCAST-COM_CM_MAC\":\"12:34:56:78:90:AB\"},{\"Device.X_RDK_GatewayManagement.Gateway.2.MacAddress\":\"12:34:56:78:90:AB\"},{\"Device.X_RDK_GatewayManagement.GatewayRestoreAttemptCount\":\"0\"},{\"Device.X_RDK_GatewayManagement.Gateway.1.OperationStatus\":\"false\"},{\"Device.X_RDK_GatewayManagement.Gateway.2.OperationStatus\":\"true\"},{\"Device.X_RDK_GatewayManagement.Gateway.1.ActiveStatus\":\"false\"},{\"Device.X_RDK_GatewayManagement.Gateway.2.ActiveStatus\":\"true\"},{\"Device.X_RDK_WanManager.InterfaceAvailableStatus\":\"LTE,1\"},{\"Device.X_RDK_WanManager.InterfaceActiveStatus\":\"LTE,1\"},{\"Device.DeviceInfo.X_RDKCENTRAL-COM_batteryBackup.supported\":\"true\"},{\"Device.DeviceInfo.X_RDKCENTRAL-COM_batteryBackup.batteryHealth\":\"0\"},{\"Device.DeviceInfo.X_RDKCENTRAL-COM_batteryBackup.batteryStatus\":\"0\"},{\"Device.DeviceInfo.X_RDKCENTRAL-COM_batteryBackup.chargingStatus\":\"0\"},{\"Device.DeviceInfo.X_RDKCENTRAL-COM_batteryBackup.estimatedChargeRemaining\":\"0\"},{\"Device.DeviceInfo.X_RDKCENTRAL-COM_batteryBackup.estimatedMinutesRemaining\":\"0\"},{\"Device.DeviceInfo.X_RDKCENTRAL-COM_batteryBackup.secondsOnBattery\":\"0\"},{\"Device.DeviceInfo.X_RDKCENTRAL-COM_batteryBackup.batteryCapacity\":\"0\"},{\"Device.Cellular.X_RDK_Status\":\"CONNECTED\"},{\"Device.Cellular.X_RDK_Enable\":\"true\"},{\"Device.Cellular.Interface.1.X_RDK_RadioEnvConditions\":\"EXCELLENT\"},{\"Device.Cellular.Interface.1.RSSI\":\"-60\"},{\"Device.Cellular.Interface.1.X_RDK_SNR\":\"21\"},{\"Device.Cellular.Interface.1.RSRP\":\"-84\"},{\"Device.Cellular.Interface.1.RSRQ\":\"-7\"},{\"Device.DeviceInfo.SerialNumber\":\"332MYTIO\"}]}");


			ParodusInfo("Notification payload Test2: {\"Report\":[{\"Profile.Name\":\"lte_bkp_periodic_report\"},{\"Profile.Version\":\".21\"},{\"timestamp\":\"1686513316.002683748\"},{\"Device.DeviceInfo.ProductClass\":\"XLE\"},{\"Device.DeviceInfo.X_COMCAST-COM_CM_MAC\":\"12:34:56:78:90:AB\"},{\"Device.X_RDK_GatewayManagement.Gateway.2.MacAddress\":\"12:34:56:78:90:AB\"},{\"Device.X_RDK_GatewayManagement.GatewayRestoreAttemptCount\":\"0\"},{\"Device.X_RDK_GatewayManagement.Gateway.1.OperationStatus\":\"false\"},{\"Device.X_RDK_GatewayManagement.Gateway.2.OperationStatus\":\"true\"},{\"Device.X_RDK_GatewayManagement.Gateway.1.ActiveStatus\":\"false\"},{\"Device.X_RDK_GatewayManagement.Gateway.2.ActiveStatus\":\"true\"},{\"Device.X_RDK_WanManager.InterfaceAvailableStatus\":\"LTE,1\"},{\"Device.X_RDK_WanManager.InterfaceActiveStatus\":\"LTE,1\"},{\"Device.DeviceInfo.X_RDKCENTRAL-COM_batteryBackup.supported\":\"true\"},{\"Device.DeviceInfo.X_RDKCENTRAL-COM_batteryBackup.batteryHealth\":\"0\"},{\"Device.DeviceInfo.X_RDKCENTRAL-COM_batteryBackup.batteryStatus\":\"0\"},{\"Device.DeviceInfo.X_RDKCENTRAL-COM_batteryBackup.chargingStatus\":\"0\"},{\"Device.DeviceInfo.X_RDKCENTRAL-COM_batteryBackup.estimatedChargeRemaining\":\"0\"},{\"Device.DeviceInfo.X_RDKCENTRAL-COM_batteryBackup.estimatedMinutesRemaining\":\"0\"},{\"Device.DeviceInfo.X_RDKCENTRAL-COM_batteryBackup.secondsOnBattery\":\"0\"},{\"Device.DeviceInfo.X_RDKCENTRAL-COM_batteryBackup.batteryCapacity\":\"0\"},{\"Device.Cellular.X_RDK_Status\":\"CONNECTED\"},{\"Device.Cellular.X_RDK_Enable\":\"true\"},{\"Device.Cellular.Interface.1.X_RDK_RadioEnvConditions\":\"EXCELLENT\"},{\"Device.Cellular.Interface.1.RSSI\":\"-60\"},{\"Device.Cellular.Interface.1.X_RDK_SNR\":\"21\"},{\"Device.Cellular.Interface.1.RSRP\":\"-84\"},{\"Device.Cellular.Interface.1.RSRQ\":\"-7\"},{\"Device.DeviceInfo.SerialNumber\":\"332MYTIO\"}]}");
